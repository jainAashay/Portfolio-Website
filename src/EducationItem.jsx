  ...
  return (
    <div className='row shadow rounded my-3' style={{backgroundColor:'black'}} >
        <div className='col-md-4 col-12'>
              <img src={process.env.PUBLIC_URL + '/images/education/' + props.data.image+'.jpg'} alt='' className='rounded py-1' style={{width:'100%',height:'18vh'}}/>
        </div>
        <div className='col-md-8 col-12 text-start pb-2'>
          <div className='fw-bold py-2 ' style={{fontSize:'1.3rem',color:'aquamarine'}}>
