    ...
    return (
        <div className='row shadow rounded my-2 bg-warning' >
            <div className='col-md-4 py-1'>
                <img src={process.env.PUBLIC_URL + '/images/achievements/' + props.AchievementItem.image} style={{ width: '100%', height: '8rem', maxHeight: '35vh',minHeight:'10vh'}} className='rounded' />
            </div>
